...
# 
# sigma = 3
# beta = c(rep(0.5,5), rep(2,5), rep(0,5), rep(5,5))
# 
...
# 
# ### ASSIGN THE GROUP ###
# v.group <- c(rep(1,5), rep(2,5), rep(3,5), rep(4,5))
# ### CORRELATION PLOT ###
# ggcorrplot(cor(X))


### FITTING FUNCTION ###
simfun <-  function(trainn = 60, validationn = 60, testn = 200, sigma = 1, 
                    beta = c(rep(0.5,5), rep(2,5), rep(0,5), rep(5,5)) ){
  ...
  oracle.betas <- c(rep(0.5,5), rep(2,5), rep(5,5)) 
...
for (i in 1:50) {
  data <- simfun(trainn = 60, validationn = 60, testn = 200, sigma = 1, 
                 beta = c(rep(0.5,5), rep(2,5), rep(0,5), rep(5,5)) );
